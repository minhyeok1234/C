...
// 조건 2. 어항의 물 높이가 0을 초과하면 100을 넘지 않는지 확인하고 물을 줌
		...
		// 모든 물고기가 죽었는지 확인
		if (checkFishAlive() == 0) { // 물고기가 모두 죽음
...
void decreaseWater(long elapsedTime) { // 어항의 물을 증발(감소)시키는 함수
	for (int i = 0; i < 6; i++) { // 어항 6개
